  ...
  render: function() {
    ...
    return (
      React.DOM.div( {className:"editor", style:style}, 
        ...
        React.DOM.textarea( {ref:"ef", className:"editor-content", value:this.state.text, onChange:this.handleChange, spellCheck:false} )
      )
    );
  },
...
},{"./editor_background":139,"diff-match-patch":2,"react":137}],139:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react');
...
},{"react":137}],140:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react');
